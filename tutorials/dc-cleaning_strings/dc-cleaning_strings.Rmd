...
Comment fields sit somewhere in between tidy tabular data entries and large text files (i.e. documents) in terms of wrangling effort. They require human nuance to decode and the quality and completeness of comments vary between individual entries.     
...
**Note:** For further details explaining the regex syntax for the last example, read [this stack overflow post](https://stackoverflow.com/questions/52431841/how-to-find-the-first-space-in-a-sentence-with-regular-expressions-within-r).       
