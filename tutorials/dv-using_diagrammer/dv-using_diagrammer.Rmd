...
knitr::include_graphics("../../figures/dv-using_diagrammer-simple_grvis.svg")  
```
...
In this example, I want to create a (rather optimistic) flow chart of my machine learning workflow to share with another data science team. This example is heavily inspired by a [blog post](https://mikeyharper.uk/flowcharts-in-r-using-diagrammer/) by Michael Harper.       
