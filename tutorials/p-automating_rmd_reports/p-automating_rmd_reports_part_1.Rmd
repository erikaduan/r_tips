...
**Note:** This tutorial uses the R base pipe `|>`, which can be accessed via **Tools/Global Options** for R version 4.1.0 and above. Using `|>` instead of `%>%` hypothetically reduces the number of R package dependencies for your automated report (a good workflow housekeeping practice).    
