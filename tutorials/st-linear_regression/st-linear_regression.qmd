...
Although model coefficients tell us how our model makes a prediction and which independent variables are predictive of the outcome, we cannot use them to evaluate whether our model is a good or poor one. To evaluate our model, we need to examine some different metrics.  
