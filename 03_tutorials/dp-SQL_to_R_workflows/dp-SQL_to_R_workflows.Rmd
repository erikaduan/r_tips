...
Enter the [DBT jaffle shop project](https://github.com/dbt-labs/jaffle_shop), which allows you to easily set up a mock data warehouse in [Google BigQuery](https://cloud.google.com/bigquery).     
...
```{r load figure 1, echo=FALSE, fig.align='center', out.width='70%'} 
...
+ An RStudio [guide](https://db.rstudio.com/getting-started/connect-to-database/) on connecting to an existing database using the `odbc` and `DBI` packages.     
