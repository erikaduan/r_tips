...
The variance of variable X, or Var(X), is a description of how far away individual values of x are from the mean and is defined below:     
...
# Knit dp-SQL_to_R_workflows-create_customers_table.jpg ------------------------
knitr::include_graphics("../../02_figures/st-expectation_and_variance-variance.jpg")  
```
...
# Knit dp-SQL_to_R_workflows-create_customers_table.jpg ------------------------
knitr::include_graphics("../../02_figures/st-expectation_and_variance-covariance.jpg")
```
...
# Knit dp-SQL_to_R_workflows-create_customers_table.jpg ------------------------   
knitr::include_graphics("../../02_figures/st-expectation_and_variance-pearson_correlation.jpg")   
```
