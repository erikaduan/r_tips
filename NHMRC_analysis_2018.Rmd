...
**Data insights:** 
* The state with the highest number of project grants was VIC, with almost twice the number of grants compared to NSW.
*  Career Development Fellowships are more disproportionately awarded to only VIC and NSW compared to other funding schemes. This may link to the decreased number of total CD fellowships funded (i.e. increased competition) and indicates that a mid-career pipeline leak may be more likely to exist, especially for non-VIC/NSW researchers.
...
**Number of institutes per state** - the assumption would be that smaller states have fewer individual institutions and this number may be a better surrogate for the number of researchers/ grant applicants per state. 
We can obtain this information from our current dataset. 
...
* **tmap** - Tennekes M (2018). "tmap: Thematic Maps in R." _Journal of Statistical Software_, *84*(6), 1-39. doi:
